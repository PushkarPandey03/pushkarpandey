        ...
        <div className={styles.grid}>
          <motion.div className={styles.infoSide} {...fadeUp(0.3)}>
            <div className={styles.contactCard}>
              ...
              <div className={styles.contactItem}>
                ...
                <div>
                  ...
                  <a href="tel:+919511237284" className={styles.contactValue}>
                    +91 9511237284
                  </a>
                </div>
              </div>
            ...
            <div className={styles.socialLinks}>
              <a href="mailto:pandeypushkar333@gmail.com" className={styles.socialBtn} aria-label="Email">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              </a>
              <a href="tel:+919511237284" className={styles.socialBtn} aria-label="Phone">
